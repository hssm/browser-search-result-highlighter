...
# Hooks
gui_hooks.browser_will_show.append(qsah._load)
gui_hooks.browser_did_search.append(qsah.did_search)
gui_hooks.browser_did_fetch_row.append(qsah._column_data)
gui_hooks.webview_will_set_content.append(qsah.on_webview_will_set_content)
gui_hooks.editor_did_load_note.append(qsah.did_load_note)
